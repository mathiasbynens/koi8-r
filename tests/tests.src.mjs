...
assert.deepStrictEqual(
	koi8r.decode(new Uint16Array([0xFFFF])),
	'\uFFFD',
...
assert.deepStrictEqual(
	koi8r.decode(new Uint16Array([0xFFFF]), { mode: 'replacement' }),
	'\uFFFD',
...
assert.throws(
	() => {
		koi8r.decode(new Uint16Array([0xFFFF]), { mode: 'fatal' });
	},
	Error,
